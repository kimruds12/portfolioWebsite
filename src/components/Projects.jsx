          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`group inline-flex items-center gap-2.5 rounded-full px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.16em] transition-all duration-300 ${
                  isActive
              ...
              >
                {cat.label}
                <span
                  className={`inline-flex h-5 min-w-[1.25rem] items-center justify-center rounded-full px-1.5 text-[10px] font-bold transition-colors duration-300 ${
                    isActive
          ...
          {filteredProjects.map((project, index) => {
            ...
            return (
              <motion.article
                ...
                className="group overflow-hidden rounded-[2rem] border border-cyan-300/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(7,20,39,0.95))] shadow-[0_18px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl transition duration-300 hover:border-cyan-300/30 hover:shadow-[0_24px_90px_rgba(56,189,248,0.12)]"
              >
                <div
                    ...
                    {project.image ? (
                      ...
                      <div className="flex h-full w-full items-center justify-center">
                        <div className="text-center p-8">
                          <i className={`${
                            project.category === 'game' ? 'fa-solid fa-gamepad' :
                  ...
                  <div className="flex flex-1 flex-col justify-center p-6 sm:p-8">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                      {project.tags.map((tag) => (
                        <span 
                          key={tag} 
                          className="flex items-center gap-2 rounded-lg border border-cyan-300/10 bg-black/40 px-4 py-2 font-mono text-[13px] text-cyan-200/90 shadow-inner transition-colors group-hover:border-cyan-300/25"
                        >
